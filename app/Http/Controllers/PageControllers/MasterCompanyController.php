...
class MasterCompanyController extends Controller
{
    ...
    {
        return view('pages.profile.master_company.index');
    }
    // Index DataTable
    ...
    public function create()
    {
        ...
        return view('pages.profile.master_company.create', ['countries' => $countries, 'states' => $states, 'addressTypes' => $addressTypes]);
    }
    // Store Date
    ...
    public function showDetails($id)
    {
        ...
        $html = view('pages.profile.master_company.show', compact('company'))->render();
