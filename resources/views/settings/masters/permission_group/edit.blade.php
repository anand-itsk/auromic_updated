                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card m-b-30">
                                ...
                                <div class="card-body">
                                    <div class="m-b-30">
                                        <form action="{{ route('user-management.permission_group.update', $permission_group->id) }}" method="POST">
                                            @csrf
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" type="text" name="name"
                                                                id="name" value="{{ $permission_group->name }}">
                                                            @error('name')
                                                                <span class="error"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="d-flex justify-content-evenly">
                                                            ...
                                                            <a href="{{ route('user-management.permission_group') }}"
