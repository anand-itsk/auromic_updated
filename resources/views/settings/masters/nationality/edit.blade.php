                        ...
                        <div class="col-12">
                            <div class="card m-b-30">
                                <div class="card-header pb-0 pt-0 bg-white">
                                    <h5>Edit Nationality</h5>
                                </div>
                                <div class="card-body">
                            <div class="m-b-30">
                                <form action="{{ route('common.nationalities.update', $nationality->id) }}" method="POST">
                                    @csrf
                                  <div class="form-group row justify-content-center">
                                      ...
                                      <div class="col-md-12">
                                          ...
                                          <label for="firstNameinput" class="form-label">Code</label>
                                            ...
                                            <input class="form-control" type="text" name="code" id="code" value="{{ $nationality->code}}">
                                            @error('code')
                                                <span class="error" style="color: red;">{{ $message }}</span>
                                            @enderror
                                        </div>
