                        ...
                        <div class="col-12">
                            <div class="card m-b-30">
                                <div class="d-flex justify-content-between p-2 bd-highlight">
                                    ...
                                    <div>
                                        <a href="{{ route('nationalities.create') }}" class="icon-link common-color"
                                            title="Create New Nationalities">
                                             ...
                                             @foreach ($nationality as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                                ...
                                                                <a href="{{ route('nationalities.edit', $item->id) }}" class="icon-link primary-color"><i
...
<script>
    function confirmDelete(id) {
        if (confirm("Are you sure you want to delete this nationality?")) {
            window.location.href = "/nationality-delete/" + id;
        }
    }
</script>
