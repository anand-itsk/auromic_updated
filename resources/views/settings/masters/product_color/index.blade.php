...
@section('content')
                        ...
                        <div class="col-12">
                            <div class="card m-b-30">
                                <div class="d-flex justify-content-between p-2 bd-highlight">
                                    ...
                                    <div>
                                        <a href="{{ route('product_colors.create') }}" class="icon-link common-color"
                                            title="Create New Product Color">
                                             ...
                                             @foreach ($product_color as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                                ...
                                                                <a href="{{ route('product_colors.edit', $item->id) }}" class="icon-link primary-color"><i
    ...
    {{ $product_color->links('pagination::bootstrap-4')}}
</div>
...
<script>
    function confirmDelete(id) {
        if (confirm("Are you sure you want to delete this Product Color?")) {
            window.location.href = "/product_color-delete/" + id;
        }
    }
</script>
