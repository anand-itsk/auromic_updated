...
@section('content')
    ...
    <strong></strong> Product Color deleted successfully.
</div>
            <div class="row">
                <div class="col-xl-2">
                    <div class="row">
...
<button id="deleteButton" class="icon-button delete-color"
                                                ...
                                                <div>
                                                    <a href="{{ route('product-models.product_colors.create') }}"
...
$(document).ready(function() {
    table = $('#users-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{route('product-models.product_colors.data')}}',
        columns: [{
                data: 'id',
                name: 'id'
            },
    ...
    $('#deleteButton').click(function() {
        ...
        if (confirm("Are you sure you want to delete these rows?")) {
            ...
            $.ajax({
                url: 'product_color/select-product_color-delete',
                type: 'POST',
                data: {
                    ids: ids,
                    _token: '{{ csrf_token() }}'
...
function editUser(id) {
    ...
    window.location.href = 'product_color/edit/' + id;
}
