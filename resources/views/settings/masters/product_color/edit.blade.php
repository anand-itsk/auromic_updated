@extends('layouts.app')
@section('title', 'Edit Prodcut Color')
<!-- DataTables CSS -->
                        ...
                        <div class="col-12">
                            <div class="card m-b-30">
                                <div class="card-header pb-0 pt-0 bg-white">
                                    <h5>Edit Product Color</h5>
                                </div>
                                <div class="card-body">
                                    <div class="m-b-30">
                                        <form
                                            action="{{ route('product-models.product_colors.update', $product_color->id) }}"
                                            method="POST">
                                            @csrf
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" type="text" name="name"
                                                                id="name" value="{{ $product_color->name }}">
                                                            @error('name')
                                                                <span class="error"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" type="text" name="code"
                                                                id="code" value="{{ $product_color->code }}">
                                                            @error('code')
                                                                <span class="error"
                                                                    style="color: red;">{{ $message }}</span>
                                                            @enderror
