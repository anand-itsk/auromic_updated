                    ...
                    <div class="page-title-box">
                        <div class="btn-group float-right">
                            <ol class="breadcrumb hide-phone p-0 m-0">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('product_colors') }}">Product Color</a></li>
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="mb-3">
                                          <label for="firstNameinput" class="form-label">Name</label>
                                            <input class="form-control" type="text" name="name" id="name" value="{{ $product_color->name }}">
                                            @error('name')
                                     ...
                                     <div class="col-md-6">   
                                       <div class="mb-3">
                                          <label for="firstNameinput" class="form-label">Code</label>
                                            ...
                                            <input class="form-control" type="text" name="code" id="code" value="{{ $product_color->code}}">
                                            @error('code')
                                                <span class="error" style="color: red;">{{ $message }}</span>
                                            @enderror
                                        </div>
