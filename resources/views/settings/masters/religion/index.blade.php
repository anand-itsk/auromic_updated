                        ...
                        <div class="col-12">
                            <div class="card m-b-30">
                                <div class="d-flex justify-content-between p-2 bd-highlight">
                                    ...
                                    <div>
                                        <a href="{{ route('religions.create') }}" class="icon-link common-color"
                                             ...
                                             @foreach ($religion as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                                ...
                                                                <a href="{{ route('religions.edit', $item->id) }}" class="icon-link primary-color"><i
                             ...
                             {{ $religion->links('pagination::bootstrap-4')}}
                                </div>
                            </div>
                        </div>
                    </div>
