...
@section('content')
    ...
    <strong></strong> Local Office deleted successfully.
</div>
            <div class="row">
                <div class="col-xl-2">
                    <div class="row">
...
$(document).ready(function() {
    table = $('#users-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{route('specified.local_offices.data')}}',
        columns: [{
                data: 'id',
                name: 'id'
            },
    ...
    $('#deleteButton').click(function() {
        ...
        if (confirm("Are you sure you want to delete these rows?")) {
            ...
            $.ajax({
                url: 'local_office/select-local_office-delete',
                type: 'POST',
                data: {
                    ids: ids,
                    _token: '{{ csrf_token() }}'
...
function editUser(id) {
    ...
    window.location.href = 'local_office-edit/' + id;
}
