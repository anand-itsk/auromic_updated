...
@section('content')
    ...
    <strong></strong> Company Type deleted successfully.
</div>
            <div class="row">
                <div class="col-xl-2">
                    <div class="row">
...
$(document).ready(function() {
    table = $('#users-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{route('specified.company_types.data')}}',
        columns: [{
                data: 'id',
                name: 'id'
            },
    ...
    $('#deleteButton').click(function() {
        ...
        if (confirm("Are you sure you want to delete these rows?")) {
            ...
            $.ajax({
                url: 'company_type/select-company_type-delete',
                type: 'POST',
                data: {
                    ids: ids,
                    _token: '{{ csrf_token() }}'
...
function editUser(id) {
    ...
    window.location.href = 'company_type/edit/' + id;
}
...
function deleteUser(id) {
    ...
    if (confirm('Are you sure you want to delete this company types?')) {
        $.ajax({
            url: 'company_type/delete/' + id,
            type: 'get',
            data: {
                _token: '{{ csrf_token() }}',
            },
