                    ...
                    <div class="page-title-box">
                        <div class="btn-group float-right">
                            <ol class="breadcrumb hide-phone p-0 m-0">
                                ...
                                <li class="breadcrumb-item active">Caste</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Caste</h4>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="card m-b-30">
                                <div class="d-flex justify-content-between p-2 bd-highlight">
                                    ...
                                    <div>
                                        <a href="{{ route('castes.create') }}" class="icon-link common-color"
                                             ...
                                             @foreach ($caste as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                                ...
                                                                <a href="{{ route('castes.edit', $item->id) }}" class="icon-link primary-color"><i
...
<script>
    function confirmDelete(id) {
        if (confirm("Are you sure you want to delete this caste?")) {
            window.location.href = "/caste-delete/" + id;
        }
    }
</script>
