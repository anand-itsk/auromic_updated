...
@section('content')
    ...
    <strong></strong> Esi Dispensary deleted successfully.
</div>
            <div class="row">
                <div class="col-xl-2">
                    <div class="row">
...
<button id="deleteButton" class="icon-button delete-color"
                                                ...
                                                <div>
                                                    <a href="{{ route('specified.esi_dispensaries.create') }}"
...
$(document).ready(function() {
    table = $('#users-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{route('specified.esi_dispensaries.data')}}',
        columns: [{
                data: 'id',
                name: 'id'
            },
    ...
    $('#deleteButton').click(function() {
        ...
        if (confirm("Are you sure you want to delete these rows?")) {
            ...
            $.ajax({
                url: 'esi_dispensary/select-esi_dispensary-delete',
                type: 'POST',
                data: {
                    ids: ids,
                    _token: '{{ csrf_token() }}'
...
function editUser(id) {
    ...
    window.location.href = 'esi_dispensary-edit/' + id;
}
