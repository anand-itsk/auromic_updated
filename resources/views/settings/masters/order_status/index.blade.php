...
@section('content')
    ...
    <strong></strong> Order Satus deleted successfully.
</div>
            <div class="row">
                <div class="col-xl-2">
                    <div class="row">
...
$(document).ready(function() {
    table = $('#users-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{route('product-models.order_statuses.data')}}',
        columns: [{
                data: 'id',
                name: 'id'
            },
    ...
    $('#deleteButton').click(function() {
        ...
        if (confirm("Are you sure you want to delete these rows?")) {
            ...
            $.ajax({
                url: 'order_status/select-order_status-delete',
                type: 'POST',
                data: {
                    ids: ids,
                    _token: '{{ csrf_token() }}'
...
function editUser(id) {
    ...
    window.location.href = 'order_status-edit/' + id;
}
