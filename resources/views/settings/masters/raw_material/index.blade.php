                                                ...
                                                <div class="modal-content">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="card m-b-30">
                                                                    <div class="card-body">
                                                                        <form
                                                                            action="{{ route('product-models.raw_materials.import') }}"
                                                                            method="POST"
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <p class="text-muted font-14">To upload sample document, it
                                                            ...
                                                            <a href="{{ asset('assets/sample_excels/raw_material_import.xlsx') }}"
                                                                download>Click
                ...
                buttons: [
                    'excel', 'print',
                    {
                        ...
                        action: function(e, dt, node, config) {
                            window.location.href = '/product-models/raw_materials/export?' + $.param(dt.ajax
                                .params());
                        }
                    }
                ],
