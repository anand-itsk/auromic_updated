...
@section('content')
    ...
    <strong></strong> Payment Mode deleted successfully.
</div>
            <div class="row">
                <div class="col-xl-2">
                    <div class="row">
...
<button id="deleteButton" class="icon-button delete-color"
                                                ...
                                                <div>
                                                    <a href="{{ route('specified.payment_modes.create') }}"
...
$(document).ready(function() {
    table = $('#users-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{route('specified.payment_modes.data')}}',
        columns: [{
                data: 'id',
                name: 'id'
            },
    ...
    $('#deleteButton').click(function() {
        ...
        if (confirm("Are you sure you want to delete these rows?")) {
            ...
            $.ajax({
                url: 'payment_mode/select-payment_mode-delete',
                type: 'POST',
                data: {
                    ids: ids,
                    _token: '{{ csrf_token() }}'
...
function editUser(id) {
    ...
    window.location.href = 'payment_mode-edit/' + id;
}
