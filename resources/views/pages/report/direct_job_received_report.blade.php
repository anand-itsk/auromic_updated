                    ...
                    <div class="card mb-2">
                        <div class="card-body">
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-sm-2 mb-2">
                                    <select class="form-control select2" name="incentive_status" id="incentive_status">
                ...
                buttons: [
                    'excel',
                    {
                        ...
                        customize: function(win) {
                            ...
                            var reportName =
                                "Direct Job Recived Report"; // Change this to the desired report name
                    ...
                    },
                    {
                        ...
                        action: function(e, dt, node, config) {
                            window.location.href = '/report/direct_job_received_report/export?' + $
                                .param(dt.ajax
                                    .params());
                        }
                    }
