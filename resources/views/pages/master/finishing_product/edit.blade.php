@extends('layouts.app')
@section('title', 'Edit Finishing Product')
<!-- DataTables CSS -->
@section('content')
    <!-- Add Select2 CSS -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            <div class="m-b-30">
                                <form action="{{ route('master.finishing_product.update', $finishing_product->id) }}"
                                    ...
                                    <div class="form-group row">
                                            ...
                                            <select class="form-control" name="product_id" id="product">
                                                ...
                                                @foreach ($products as $product)
                                                    <option value="{{ $product->id }}"
                                                        {{ $finishing_product->product_id == $product->id ? 'selected' : '' }}>
                                                        {{ $product->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select class="form-control" name="product_size_id" id="product_size_id">
                                                ...
                                                @foreach ($product_size as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $finishing_product->product_size_id == $item->id ? 'selected' : '' }}>
                                                        {{ $item->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-sm-4 mb-4">
                                            <input class="form-control" type="text" name="model_code" id="model_code"
                                                value="{{ $finishing_product->model_code }}">
                                            @error('model_code')
                                                <span class="error" style="color: red;">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-sm-4 mb-4">
                                            <input class="form-control" type="text" name="model_name" id="model_name"
                                                value="{{ $finishing_product->model_name }}">
                                            @error('model_name')
                                                <span class="error" style="color: red;">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-sm-4 mb-4">
                                            <input class="form-control" type="text" name="wages_one_product"
                                                id="wages_one_product"value="{{ $finishing_product->wages_one_product }}">
