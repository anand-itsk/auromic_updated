        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Edit Finishing Product</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="m-b-30">
                            <form action="{{ route('master.finishing_product.update',$finishing_product->id) }}" method="POST"
...
<div class="col-sm-4 mb-4">
    ...
    @foreach($products as $product)
        <option value="{{ $product->id }}" {{ $finishing_product->product_id == $product->id ? 'selected' : '' }}>
            {{ $product->name }}
        </option>
    @endforeach
</select>
...
<div class="col-sm-4 mb-4">
    ...
    @foreach($product_size as $item)
        <option value="{{ $item->id }}" {{ $finishing_product->product_size_id == $item->id ? 'selected' : '' }}>
            {{ $item->name }}
        </option>
    @endforeach
</select>
...
<label for="wages_product" class="col-sm-2 col-form-label mandatory">Model Code</label>
  <div class="col-sm-4 mb-4">
    <input class="form-control" type="text" name="model_code" id="model_code" value="{{$finishing_product->model_code}}">
    @error('model_code')
    <span class="error" style="color: red;">{{ $message }}</span>
    @enderror
</div>
...
<label for="wages_product" class="col-sm-2 col-form-label">Model Name</label>
  <div class="col-sm-4 mb-4">
    <input class="form-control" type="text" name="model_name" id="model_name"  value="{{$finishing_product->model_name}}">
    @error('model_name')
    <span class="error" style="color: red;">{{ $message }}</span>
    @enderror
</div>
<label for="wages_product" class="col-sm-2 col-form-label">Date</label>
  <div class="col-sm-4 mb-4">
    <input class="form-control" type="date" name="date" id="date" value="{{$finishing_product->date}}">
    @error('date')
    <span class="error" style="color: red;">{{ $message }}</span>
    @enderror
</div>
...
<label for="wages_product" class="col-sm-2 col-form-label">Wages of one Product</label>
  <div class="col-sm-4 mb-4">
    <input class="form-control" type="text" name="wages_one_product" id="wages_one_product"value="{{$finishing_product->wages_one_product}}">
