...
<html lang="en">
   ...
   <body>
      ...
      <hr class="my-1">
      <h5 class="font-weight-lighter text-center text-primary"style="text-align-last: center">Personal Details
      </h5>
      <table class="table table-borderless">
         <thead>
            <tr>
               <th >
                  <h6 class="font-weight-lighter text-primary" style="padding-right: 45px;">Permanent Address</h6>
               </th>
               <th >
                  <h6 class="font-weight-lighter text-primary" style="padding-right: 45px;">Correspondence Address</h6>
               </th>
               <th >
                  <h6 class="font-weight-lighter text-primary" style="padding-right: 45px;">Identity Proof</h6>
               </th>
            </tr>
         </thead>
         <tbody>
      ...
      <table class="table table-borderless">
         <thead>
            <tr>
               <th >
                  <h6 class="font-weight-lighter text-primary" style="text-align: justify">Other Details</h6>
               </th>
            </tr>
         </thead>
         <tbody>
      ...
      <hr class="my-1" />
      <h5 class="font-weight-lighter text-center text-primary" style="text-align-last: center">Finance
         Details
      </h5>
      <table class="table table-borderless">
         <thead>
            <tr>
               <th >
                  <h6 class="font-weight-lighter text-primary" style="text-align: justify">Banking Info</h6>
               </th>
               <th >
                  <h6 class="font-weight-lighter text-primary" style="text-align: justify">LIC Info</h6>
               </th>
               <th >
                  <h6 class="font-weight-lighter text-primary"style="text-align: justify">PF Info</h6>
               </th>
               <th >
                  <h6 class="font-weight-lighter text-primary"style="text-align: justify">ESI Info</h6>
               </th>
            </tr>
         </thead>
         <tbody>
      ...
      <hr class="my-1" />
      {{-- Family Members --}}
      <h5 class="font-weight-lighter mt-4 text-center text-primary" style="text-align-last: center">Family Member
         Details
      </h5>
      ...
      <hr class="my-1" />
      {{-- Nominess Members --}}
      <h5 class="font-weight-lighter mt-4 text-center text-primary" style="text-align-last: center">Nominee
         Details
      </h5>
      <table class="table table-striped table-bordered dt-responsive nowrap"
         style="border-collapse: collapse; border-spacing: 0; width: 100%;">
