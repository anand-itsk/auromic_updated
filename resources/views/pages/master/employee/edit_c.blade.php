                                                    ...
                                                    <div class="tab-pane active" role="tabpanel" id="step1">
                                                        ...
                                                        <form role="form"
                                                            ...
                                                            <div class="row mx-2 mt-0">
                                                                ...
                                                                $selected_country_id = $officeAddress->country_id ?? null;
                                                                $selected_state_id = $officeAddress->state_id ?? null;
                                                                $selected_district_id = $officeAddress->district_id ?? null;
                                                            @endphp
                                                            
                                                            <h5 class="text-primary w-100 mt-0">Permanent Address</h5>
                                                            
                                                            <div class="form-group row w-100">
                                                                <label for="office_address" class="col-sm-2 col-form-label">Address</label>
                                                                <div class="col-sm-4 mb-4">
                                                                ...
                                                                <label for="office_area" class="col-sm-2 col-form-label">Village/Area</label>
                                                                <div class="col-sm-4 mb-4">
                                                                    <input class="form-control" type="text" value="{{ $officeAddress->village_area ?? '' }}" name="office_area" id="office_area">
                                                                    @error('office_area')
                                                                        <span class="error text-danger">{{ $message }}</span>
                                                                    @enderror
                                                                </div>
                                                                ...
                                                                <div class="col-sm-4 mb-4">
                                                                    <select class="form-control select2 office_country_id" name="office_country_id" id="office_country_id">
                                                                        <option value="">Select Country</option>
                                                                        @foreach ($countries as $item)
                                                                            <option value="{{ $item->id }}" {{ $selected_country_id == $item->id ? 'selected' : '' }}>
                                                                                {{ $item->name }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>
                                                                ...
                                                                <div class="col-sm-4 mb-4">
                                                                    <select class="form-control select2 office_state_id" name="office_state_id" id="office_state_id" {{ $selected_country_id ? '' : 'disabled' }}>
                                                                ...
                                                                <div class="col-sm-4">
                                                                    <select class="form-control select2 office_district_id" name="office_district_id" id="office_district_id" {{ $selected_state_id ? '' : 'disabled' }}>
                                                            ...
                                                            <div class="row m-2">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <label class="col-sm-2 col-form-label">Select with
                                                                        reason <button type="button" class="btn btn-primary"
                                                                            data-toggle="modal"
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <select class="form-control resigning_reason_id select2"
