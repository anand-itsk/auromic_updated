@extends('layouts.app')
<!-- DataTables CSS -->
@section('title', 'Direct Job Received')
                                            ...
                                            <div class="ml-3 d-flex flex-wrap px-4">
                                                <label>
                                                    <input class="form-check-input"
                                                        name="Direct_Job_Received_Without_Giving" type="checkbox"
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#users-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('job_allocation.direct_job_received.data') }}',
                    data: function(d) {
                ...
                buttons: [
                    'excel', 'print',
                    {
                        ...
                        action: function(e, dt, node, config) {
                            window.location.href = '/job_allocation/direct_job_received/export?' + $
                                .param(dt.ajax
                                    .params());
                        }
                    }
