        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="m-b-30">
     <form action="{{ route('job_allocation.direct_job_giving.update',$direct_job_without_giving->id) }}" method="POST">
    @csrf
...
<div class="col-sm-4 mb-4">
   <select class="form-control" name="finishing_product_models_id" id="finishing_product_models_id">
        ...
        @foreach ($finishingProduct as $finishingProducts)
             ...
             <option value="{{ $finishingProducts->id }}" @if ($finishingProducts->id == $direct_job_without_giving->finishing_product_models_id) selected @endif>{{ $finishingProducts->model_code }}</option>
        @endforeach
    </select>
...
<div class="col-sm-4 mb-4">
    ...
    <input class="form-control" type="text" name="product_size" id="product_size" readonly value="{{ $direct_job_without_giving->finishingProduct->productSize->code ?? '' }}">
...
<div class="col-sm-4 mb-4">
    ...
    <input class="form-control" type="text" name="received_quantity" id="received_quantity"value="{{ $direct_job_without_giving->received_quantity?? '' }}">
...
<div class="col-sm-4 mb-4">
    ...
    <input class="form-control" type="date" name="receving_date" id="receving_date"value="{{ $direct_job_without_giving->receving_date?? '' }}">
...
<div class="col-sm-4 mb-4">
    <input class="form-control" type="text" name="meter" id="meter"  readonly value="{{$direct_job_without_giving->finishingProduct->meters_one_product ?? ''}}">
    @error('meter')
        <span class="error" style="color: red;">{{ $message }}</span>
    @enderror
</div>
