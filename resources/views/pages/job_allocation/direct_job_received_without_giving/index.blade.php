@extends('layouts.app')
<!-- DataTables CSS -->
@section('title', 'Direct Job Received Without Giving')
@section('content')
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#users-table').DataTable({
                ...
                serverSide: true,
                 ajax: {
                    url: '{{ route('job_allocation.direct_job_wc_giving.data') }}',
                    data: function(d) {
 ...
 function updateSelectedFilters() {
            ...
            $('#deleteButton').click(function() {
                ...
                if (confirm("Are you sure you want to delete these rows?")) {
                    ...
                    $.ajax({
                        url: '/job_allocation/direct_job_wc_giving/delete/selected',
                        type: 'POST',
                        data: {
                            ids: ids,
                            _token: '{{ csrf_token() }}'
        ...
        function deleteCustomer(id) {
            ...
            if (confirm('Are you sure you want to delete this Direct job Received Without giving?')) {
                $.ajax({
