                            ...
                            <div class="m-b-30">
                                <form action="{{ route('job_allocation.job_reallocation.store') }}" method="POST"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 mb-4">
                                            <input type="text" class="form-control" name="" id=""
                                                readonly value="{{ $Job_Giving->product_model->rawMaterial->name }}">
                                            @error('employee_id')
                                                <span class="error" style="color: red;">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-sm-4 mb-4">
                                            <input type="text" class="form-control" name="available_quantity"
                                                id="available_quantity" readonly value="">
                                            @error('employee_id')
                                                <span class="error" style="color: red;">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-sm-4 mb-4">
                                            <input type="text" class="form-control" name="" id=""
                                                readonly value="{{ $jobReceivedData->receving_date ?? '' }}">
                                            @error('employee_id')
                                                <span class="error" style="color: red;">{{ $message }}</span>
                                            @enderror
                                        </div>
