...
@section('title', 'Edit Client Companies')
<!-- DataTables CSS -->
@section('content')
<!-- Add Select2 CSS -->
                ...
                <div class="page-title-box">
                    <div class="btn-group float-right">
                        <ol class="breadcrumb hide-phone p-0 m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('profile.clients.index') }}">Client
                                    Company</a>
                            </li>
                            <li class="breadcrumb-item">Edit</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Edit Client Company</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card m-b-30">
                    <div class="card-body">
                        <div class="m-b-30">
                            <form action="{{ route('profile.clients.update', $company->id) }}" method="POST"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10 mb-4">
                                        <textarea class="form-control" name="office_address" id="office_address"
                                            cols="10" rows="3">{{ $officeAddress->address ?? '' }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 mb-4">
                                        <input class="form-control" type="date" name="starting_date" id="starting_date"
                                            value="{{ $company->starting_date }}">
                                        @error('starting_date')
                                        <span class="error" style="color: red;">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4 mb-4">
                                        <input class="form-control" type="text" name="faorhus_name"
                                            value="{{ $company->authorisedPerson->faorhus_name ?? ''}}"
                                            id="faorhus_name">
                                        @error('faorhus_name')
                                        <span class="error" style="color: red;">{{ $message }}</span>
                                        @enderror
