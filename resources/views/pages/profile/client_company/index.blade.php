            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Client Company</h4>
                    </div>
                    <div class="row">
                        <div class="col-12">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="card m-b-30">
                                                            <div class="card-body">
                                                                <form action="{{ route('profile.clients.import') }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('profile.clients.data') }}',
                columns: [{
                        data: 'id',
                        name: 'id'
                    },
                ...
                buttons: [
                    'excel', 'print',
                    {
                        ...
                        action: function(e, dt, node, config) {
                            window.location.href = '/profile/clients/export?' + $.param(dt.ajax
                                .params());
                        }
                    }
                ]
            ...
            $('#deleteButton').click(function() {
                ...
                if (confirm("Are you sure you want to delete these rows?")) {
                    ...
                    $.ajax({
                        url: '/profile/clients/delete/selected',
                        type: 'POST',
                        data: {
                            ids: ids,
                            _token: '{{ csrf_token() }}'
        ...
        function edit(id) {
            ...
            window.location.href = '/profile/clients/edit/' + id;
        }
        ...
        function showDetails(userId) {
            ...
            $.ajax({
                url: '/profile/clients/show/' + userId,
                type: 'GET',
                success: function(response) {
