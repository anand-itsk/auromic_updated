@extends('layouts.app')
@section('title', 'Create Client Companies')
<!-- DataTables CSS -->
@section('content')
    <!-- Add Select2 CSS -->
                                ...
                                <form action="{{ route('profile.clients.store') }}" method="POST"
                                    ...
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <button class="btn btn-secondary cancel_btn">
                                            ...
                                            <a href="{{ route('profile.clients.index') }}" class="text-white">
                                                Cancel
                                            </a>
                                        </button>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4 mb-4">
                                            <select class="form-control select2" name="master_company" id="master_company" required>
